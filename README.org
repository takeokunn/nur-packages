...
| =runn=                           | Package/tool for running operations following a scenario                          |
...
| =terraform-mcp-server=           | Terraform MCP Server for Infrastructure as Code automation                        |
