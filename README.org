...
| Package | Description                                           |
|---------+-------------------------------------------------------|
| =arto=  | Native macOS Markdown reader with GitHub-style render |
...
| =metabase-mcp=                   | MCP server for Metabase integration                                               |
| =kakehashi=                      | Tree-sitter based Language Server bridging multiple language servers               |
| =paredit-cli=                    | Structure-editing CLI for safe S-expression refactoring by AI coding agents        |
...
| =emacs-soft-narrow=        | Narrow-to-region with more eye-candy             |
...
| =emacs-warm-mode=          | Warm Emacs colors for nighttime coding           |
| =emacs-arto=               | Open Markdown files in Arto (macOS)              |
